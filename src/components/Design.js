  ...
  return (
    ...
    >
      <motion.button
        ...
        } gap-3 t:gap-6 t:py-12 d:items-center bg-blend-multiply transition duration-300 ease-in-out transform hover:scale-105 bg-dark-grey hover:bg-peach bg-opacity-75 bg-no-repeat bg-center bg-cover bg-m-${link} t:bg-t-${link} d:bg-d-${link} rounded-xl`}
      >
